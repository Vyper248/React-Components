    ...
    return (
    	<div className='App'>
			...
			<Container>
				...
				<DropdownContainer heading='Buttons' open={false} instant={true}>
				...
				<DropdownContainer heading='Confirmation Buttons' open={false} instant={true}>
				...
				<DropdownContainer heading='Loading Indicators' open={false} instant={true}>
					<Loading1 color='blue'/>
				...
				<DropdownContainer heading='Inputs' open={false} instant={true}>
				...
				<DropdownContainer heading='Labelled Inputs' open={false} instant={true}>
				...
				<DropdownContainer heading='Dropdowns' open={false} instant={true}>
				...
				<DropdownContainer heading='Tables' open={false} instant={true}>
				...
				<DropdownContainer heading='Modals' open={false} instant={true}>
				...
				<DropdownContainer heading='Containers' open={false} instant={true}>
					...
					<DropdownContainer heading='Dropdown Container'>
						...
						<p>Dolore eiusmod elit fugiat laborum tempor deserunt ut adipisicing consequat. Proident ea Lorem velit ex incididunt esse. Mollit consectetur sunt nisi esse nostrud elit minim tempor do eu ad.</p>
						<p>Id aliquip excepteur magna veniam aliquip occaecat in dolor laboris et non. Anim veniam labore adipisicing officia irure enim commodo aute commodo dolore et. Laboris sunt velit sunt cupidatat amet reprehenderit labore enim eiusmod veniam ipsum dolor.</p>
